...
public class WaitTool {
	...
	/**
	  ...
	  * 
	  * Some sites I have tested required a page refresh to add additional elements to the DOM.  
...
/*
 * References: 
 * 1. Explicit and Implicit Waits: http://seleniumhq.org/docs/04_webdriver_advanced.html
 * 
 * Note: 
